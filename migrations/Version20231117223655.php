 ...
 */
final class Version20231117223655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hotel ADD staff_id INT NOT NULL');
        $this->addSql('ALTER TABLE hotel ADD CONSTRAINT FK_3535ED9D4D57CD FOREIGN KEY (staff_id) REFERENCES staff (id)');
        $this->addSql('CREATE INDEX IDX_3535ED9D4D57CD ON hotel (staff_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3535ED9D4D57CD ON hotel');
        $this->addSql('ALTER TABLE hotel DROP staff_id');
    }
}
